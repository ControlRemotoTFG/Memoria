...
Algo muy habitual en el mundo de la electr\'onica es la posibilidad de interactuaci\'on por parte del usuario. Esta idea no es nueva y se lleva aplicando desde finales de los a\~nos 60 cuando Douglas Engelbart invent\'o el que se conoce como el primer rat\'on. Este dispositivo fue conocido en sus inicios por ser un indicador de la posici\'on x-y en la pantalla de un ordenador. La idea principal era abandonar el uso de instrucciones u \'ordenes para que el usuario se comunicase con el ordenador. Este rat\'on ten\'ia un \'unico bot\'on y una carcasa de madera. Debajo de esta carcasa se encontraban 
